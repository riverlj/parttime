...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        self.groundImage = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, kUIScreenWidth, 158)];
...
//        [self.contentView addSubview:self.groundImage];
        ...
        self.line = [[UIImageView alloc] initWithFrame:CGRectMake(15, self.nameLabel.frame.size.height+self.nameLabel.frame.origin.y, kUIScreenWidth-30, 1)];
        self.line.image = [UIImage imageNamed:@"xuxian"];
        [self.contentView addSubview:self.line];
        
        self.chuLiLabel = [[UILabel alloc] initWithFrame:CGRectMake(kUIScreenWidth-170, 7, 170, 30)];
        ...
        self.lineImage = [[UIImageView alloc] initWithFrame:CGRectMake(40, self.foodLabel.frame.size.height+self.foodLabel.frame.origin.y+7, kUIScreenWidth-55, 1)];
